...
class IndeedSearchSpider(scrapy.Spider):
    ...
    def get_indeed_search_url(self, keyword, location, offset=0):
        ...
        return "https://www.indeed.com/jobs?" + 'jobs?q={}&l={}&start={}&filter=0'.format(keyword, location, offset)#urlencode(parameters)

    def start_requests(self):
        keyword_list = ["Cloud System Engineer", "Help Desk Technician",
                        ...
                        "System analyst", "IT technician", "Web developer",
                        "Quality assurance tester", "Support specialist"]
        location_list = ['San Francisco', 'London']
